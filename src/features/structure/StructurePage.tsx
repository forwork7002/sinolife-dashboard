 ...
 * a fact about today; the two figures that were period-scoped are gone. See
 * SCREENS_WITHOUT_A_PERIOD in Shell.tsx for the rule and the test that keeps
 * the two sides of it together.
 *
