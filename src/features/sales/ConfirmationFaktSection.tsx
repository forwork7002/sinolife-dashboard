...
const QUEUE_BASIS = 'Navbatga tushgan sana (C4:NEW) boʻyicha'
...
/**
 * One figure at hero size, in the hero card's own three-state discipline.
 *
 * The same skeleton / «Olinmadi» / number the revenue figure beside it has
 * had since this card was built — written once here because there are three
 * of them on the row now, and a headline that loses its states is a confident
 * number over a failed request.
 */
function HeroFigure({
  label,
  value,
      ...
      {status === 'loading' ? (
        ...
        <div className="mt-1.5">
          {/*
            ...
            scan these two figures, it reconciles them: against the Тасдиқлаш
            kanban, against the bot's own Telegram totals, against the
            client's published page. «106 mln» cannot be compared with
            «106 432 000» without opening a tooltip, and this is where that
